              ...
              <div className='form-group'>
                <label>Images</label>
                    ...
                    {oldImages && oldImages.map(img =>(
                        <img src={img.url} key={img} alt={img.url} className="mt-3 mr-2" height="52" width="55" />
                    ))}
                    {imagesPreview.map(img =>(
                        <img src={img} key={img} alt="Images preview" className="mt-3 mr-2" height="52" width="55" />
                    ))}
            </div>
